...
-- Design Ports Information
-- B	=>  Location: PIN_W2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF testeBUS IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL ww_A : std_logic_vector(0 TO 1);
...
-- Equation(s):
-- \inst~combout\ = (\A[0]~input_o\ & \A[1]~input_o\)
